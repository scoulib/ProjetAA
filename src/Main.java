    ...
    public static void main(String[] args) {
        ...
        while(instancesPositifs[0].size() != 0 && !map2.isEmpty()) {
            ...
            for (Map.Entry<Attribute, String> entry : meilleurCandidat.entrySet()) {
                ...
                /*for (Map.Entry<String, List<String>> entri : candidats.entrySet()) {
                    if(instances.attribute(entri.getKey()) == key && entri.getValue().contains(val)) {
                        candidats.remove(entri.getKey());
                ...
                while(negNouvelleRegle.size() != 0) {
                    ...
                    meilleurCandidat.forEach((key1, val1) -> {
                       ...
                       /*for (int i = negNouvelleRegle.numInstances() - 1; i >= 0; i--) {
                            Instance instan = negNouvelleRegle.get(i);
                            if (instan.stringValue(instances.attribute(key1.name()).index()) == val1) {
                                System.out.println("*******Supression negNouvelleRegle***********");
                                negNouvelleRegle.delete(i);
                            }
                        }*/
            ...
            System.out.println("////////////////////////////"+posNouvelleRegle.numInstances()+"//////////////////////////");
            instances.delete();
